...
class Interview(models.Model):
    ...
    comunicacion_r = models.IntegerField(validators=[MinValueValidator(MIN), MaxValueValidator(MAX)],default=100)
    #__________________2
    ...
    trabajo_equipo_r = models.IntegerField(validators=[MinValueValidator(MIN), MaxValueValidator(MAX)],default=100)
    #__________________3
    ...
    servicio_cliente_r = models.IntegerField(validators=[MinValueValidator(MIN), MaxValueValidator(MAX)],default=100)
    #__________________4
    ...
    resolucion_problemas_r = models.IntegerField(validators=[MinValueValidator(MIN), MaxValueValidator(MAX)],default=100)
    #__________________5
    ...
    liderazgo_r = models.IntegerField(validators=[MinValueValidator(MIN), MaxValueValidator(MAX)],default=100)
    #__________________6
    ...
    admon_tiempo_r = models.IntegerField(validators=[MinValueValidator(MIN), MaxValueValidator(MAX)],default=100)
    #__________________7
    ...
    pensamiento_estrategico_r = models.IntegerField(validators=[MinValueValidator(MIN), MaxValueValidator(MAX)],default=100)	 
    #__________________8
    ...
    enfoque_resultados_r = models.IntegerField(validators=[MinValueValidator(MIN), MaxValueValidator(MAX)],default=100)
    #=========================================================================================
    result = models.CharField(max_length=50,default="0")
    #=========================================================================================
